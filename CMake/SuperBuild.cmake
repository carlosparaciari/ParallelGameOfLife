...
# This allows switching branches in the GAMEOFLIFE source code and build GAMEOFLIFE quickly, even if the
...
# GAMEOFLIFE-configure timestamp manually before doing a superbuild. Without that the CMake cache is
...
set(EP_COMMON_ARGS
  ...
  "-DCMAKE_CXX_FLAGS:STRING=${CMAKE_CXX_FLAGS} ${GAMEOFLIFE_CXX11_FLAG}"
  #debug flags
...
set(GAMEOFLIFE_SUPERBUILD_DEBUG_POSTFIX d)
...
######################################################################
# Now compile GAMEOFLIFE, using the packages we just provided.
######################################################################
if(NOT DEFINED SUPERBUILD_EXCLUDE_GAMEOFLIFEBUILD_TARGET OR NOT SUPERBUILD_EXCLUDE_GAMEOFLIFEBUILD_TARGET)
  ...
  ExternalProject_Add(${proj}
    ...
    CMAKE_ARGS
      ...
      -DGAMEOFLIFE_SUPERBUILD_DEBUG_POSTFIX:STRING=${GAMEOFLIFE_SUPERBUILD_DEBUG_POSTFIX}
    CMAKE_CACHE_ARGS
      ${EP_COMMON_CACHE_ARGS}
      -DCMAKE_LIBRARY_PATH:PATH=${CMAKE_LIBRARY_PATH}
      -DCMAKE_INCLUDE_PATH:PATH=${CMAKE_INCLUDE_PATH}
      -DGAMEOFLIFE_EXTERNAL_PROJECT_PREFIX:PATH=${ep_prefix}
      -DGAMEOFLIFE_USE_KWSTYLE:BOOL=${GAMEOFLIFE_USE_KWSTYLE}
      -DGAMEOFLIFE_USE_CPPCHECK:BOOL=${GAMEOFLIFE_USE_CPPCHECK}
      -DCMAKE_INSTALL_PREFIX:PATH=${CMAKE_INSTALL_PREFIX}
      -DCMAKE_VERBOSE_MAKEFILE:BOOL=${CMAKE_VERBOSE_MAKEFILE}
      -DBUILD_TESTING:BOOL=${BUILD_TESTING} # The value set in EP_COMMON_ARGS normally forces this off, but we may need GAMEOFLIFE to be on.
