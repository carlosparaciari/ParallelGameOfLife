...
string(REPLACE "^^" ";" GAMEOFLIFE_USE_Boost_LIBRARIES "${GAMEOFLIFE_USE_Boost_LIBRARIES}")

set(proj Boost)
set(proj_DEPENDENCIES )
set(Boost_DEPENDS ${proj})

if(NOT DEFINED BOOST_ROOT AND NOT GAMEOFLIFE_USE_SYSTEM_Boost)
  ...
  if(GAMEOFLIFE_USE_Boost_LIBRARIES)
    string(REPLACE ";" "," _boost_libs "${GAMEOFLIFE_USE_Boost_LIBRARIES}")
    foreach(_boost_lib ${GAMEOFLIFE_USE_Boost_LIBRARIES})
  ...
  set(_boost_cxxflags )
  if(CMAKE_CXX_FLAGS OR GAMEOFLIFE_CXX11_FLAG)
    set(_boost_cxxflags "cxxflags=${GAMEOFLIFE_CXX11_FLAG} ${CMAKE_CXX_FLAGS}")
  endif()
  ...
  # Manual install commands (for a GAMEOFLIFE super-build install)
