...
OPTION(GAMEOFLIFE_USE_CPPCHECK "Enable the use of CppCheck for static analysis." OFF)
IF(GAMEOFLIFE_USE_CPPCHECK)
  ...
  IF(CPPCHECK_EXECUTABLE)
    ...
    IF(CPPCHECK_FOUND)
      ...
      #  Define file names
      #
      SET(CPPCHECK_GAMEOFLIFE_FILES_LIST
        ${PROJECT_BINARY_DIR}/Utilities/CppCheck/GAMEOFLIFEFiles.txt)

      #
      # Configure the files
      #
      CONFIGURE_FILE(
        ${PROJECT_SOURCE_DIR}/Utilities/CppCheck/GAMEOFLIFEFiles.txt.in
        ${CPPCHECK_GAMEOFLIFE_FILES_LIST})

      SET(CPPCHECK_ARGUMENTS_CODE
        --file-list=${CPPCHECK_GAMEOFLIFE_FILES_LIST}
      ...
      ADD_CUSTOM_COMMAND(
        OUTPUT  ${GAMEOFLIFE_BINARY_DIR}/CppCheckCodeReport.txt
        COMMAND ${CPPCHECK_EXECUTABLE}
        ARGS    ${CPPCHECK_ARGUMENTS_CODE}
        COMMENT "Coding Style Checker"
      )

      ADD_CUSTOM_TARGET(StaticallyAnalyzeCode DEPENDS ${GAMEOFLIFE_BINARY_DIR}/CppCheckCodeReport.txt)

      ADD_TEST(CppCheck ${CPPCHECK_EXECUTABLE} ${CPPCHECK_ARGUMENTS_CODE})

    ENDIF(CPPCHECK_FOUND)
  ENDIF(CPPCHECK_EXECUTABLE)
ENDIF(GAMEOFLIFE_USE_CPPCHECK)
