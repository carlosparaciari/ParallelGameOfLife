...
OPTION(GAMEOFLIFE_USE_KWSTYLE "Enable the use of KWStyle for checking coding style." OFF)
IF(GAMEOFLIFE_USE_KWSTYLE)
...
SET(KWSTYLE_CONFIGURATION_FILE 
  ${PROJECT_BINARY_DIR}/Utilities/KWStyle/GAMEOFLIFEKWS.xml)

SET(KWSTYLE_GAMEOFLIFE_FILES_LIST
  ${PROJECT_BINARY_DIR}/Utilities/KWStyle/GAMEOFLIFEFiles.txt)

SET(KWSTYLE_GAMEOFLIFE_OVERWRITE_FILE
  ${PROJECT_SOURCE_DIR}/Utilities/KWStyle/GAMEOFLIFEOverwrite.txt )

#
# Configure the files
#
CONFIGURE_FILE(
  ${PROJECT_SOURCE_DIR}/Utilities/KWStyle/GAMEOFLIFEFiles.txt.in
  ${KWSTYLE_GAMEOFLIFE_FILES_LIST})

CONFIGURE_FILE(
  ${PROJECT_SOURCE_DIR}/Utilities/KWStyle/GAMEOFLIFEKWS.xml.in
...
SET(KWSTYLE_ARGUMENTS_CODE
  -xml ${KWSTYLE_CONFIGURATION_FILE} -v -D ${KWSTYLE_GAMEOFLIFE_FILES_LIST}
  -o ${KWSTYLE_GAMEOFLIFE_OVERWRITE_FILE} ${KWSTYLE_EDITOR_FORMAT}
  )

ADD_CUSTOM_COMMAND(
  OUTPUT  ${GAMEOFLIFE_BINARY_DIR}/KWStyleCodeReport.txt
  COMMAND ${KWSTYLE_EXECUTABLE}
  ARGS    ${KWSTYLE_ARGUMENTS_CODE}
  COMMENT "Coding Style Checker"
  )

ADD_CUSTOM_TARGET(StyleCheckCode DEPENDS ${GAMEOFLIFE_BINARY_DIR}/KWStyleCodeReport.txt)

ADD_TEST(KWStyle ${KWSTYLE_EXECUTABLE} ${KWSTYLE_ARGUMENTS_CODE})

ENDIF(KWSTYLE_FOUND)
ENDIF(KWSTYLE_EXECUTABLE)
ENDIF(GAMEOFLIFE_USE_KWSTYLE)
